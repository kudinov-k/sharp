...
export default function(i: PerfectScrollbar) {
  ...
  function shouldPreventDefault(deltaX: any, deltaY: any) {
  ...
  if (typeof window.onwheel !== 'undefined') {
    i.eventManager.bind(element, 'wheel', mousewheelHandler)
  } else if (typeof window.onmousewheel !== 'undefined') {
    i.eventManager.bind(element, 'mousewheel', mousewheelHandler)
  }
}
