...
import { PerfectScrollbarConfigInterface, PerfectScrollbarEvent, PerfectScrollbarEvents } from './perfect-scrollbar.interfaces'
...
@Component({
  ...
  styleUrls: [
    ...
    '../../perfect-scrollbar/css/perfect-scrollbar.scss'
  ],
